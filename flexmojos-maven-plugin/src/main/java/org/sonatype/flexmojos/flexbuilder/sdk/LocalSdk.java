...
public class LocalSdk
{
    ...
    public enum Version
    {
        FLEX3_0_0( "3" ), FLEX3_1_0( "3.1" ), FLEX3_2_0( "3.2" ), FLEX3_3_0( "3.3" ), FLEX3_4_0( "3.4" ), FLEX3_5_0(
            "3.5" ), FLEX4_0_0( "4" );
    ...
    private Version getBestVersion( String version )
    {
        ...
        while ( v == null )
        {
            ...
            else
            {
                ...
                log.warn( String.format( "Unable to find local SDK metadata for %s. Defaulting to latest known version %s.",
                                         requestedVersion, v.getVersion() ) );
            }
        }
        return v;
    }
        ...
        switch ( v )
        {
            case FLEX4_0_0:
                ...
                if ( !map.containsKey( "automation" ) )
                    map.put( "automation", new LocalSdkEntry( SDK_GROUP_ID, "automation",
                ...
                if ( !map.containsKey( "automation_agent" ) )
                    map.put( "automation_agent",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_agent",
                                                "${PROJECT_FRAMEWORKS}/libs/automation/automation_agent.swc", null,
                                                projectType, null ) );
                // New
                if ( !map.containsKey( "automation_air" ) )
                    map.put( "automation_air",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_air",
                                                "${PROJECT_FRAMEWORKS}/libs/automation/automation_air.swc",
                                                "${PROJECT_FRAMEWORKS}/projects/automation_air/src", projectType, null ) );
                // New
                if ( !map.containsKey( "automation_airspark" ) )
                    map.put( "automation_airspark",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_airspark",
                                                "${PROJECT_FRAMEWORKS}/libs/automation/automation_airspark.swc",
                                                "${PROJECT_FRAMEWORKS}/projects/automation_airspark/src", projectType,
                                                null ) );
                // No longer part of standard dependencies. Path changed.
                if ( !map.containsKey( "automation_dmv" ) )
                    map.put( "automation_dmv",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_dmv",
                                                "${PROJECT_FRAMEWORKS}/libs/automation/automation_dmv.swc",
                                                "${PROJECT_FRAMEWORKS}/projects/automation_dmv/src", projectType, null ) );
                // No longer part of standard dependencies. Path changed.
                if ( !map.containsKey( "automation_flashflexkit" ) )
                    map.put( "automation_flashflexkit",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_flashflexkit",
                ...
                if ( !map.containsKey( "automation_spark" ) )
                    map.put( "automation_spark",
                             new LocalSdkEntry( SDK_GROUP_ID, "automation_spark",
                                                "${PROJECT_FRAMEWORKS}/libs/automation/automation_spark.swc",
                                                "${PROJECT_FRAMEWORKS}/projects/automation_spark/src", projectType,
                                                null ) );
                // New
                if ( !map.containsKey( "qtp_air" ) )
                    map.put( "qtp_air", new LocalSdkEntry( SDK_GROUP_ID, "qtp_air",
                                                           "${PROJECT_FRAMEWORKS}/libs/automation/qtp_air.swc", null,
                                                           projectType, null ) );
                // No longer part of standard dependencies. Path changed.
                if ( !map.containsKey( "qtp" ) )
                    map.put( "qtp", new LocalSdkEntry( SDK_GROUP_ID, "qtp",
                                                       "${PROJECT_FRAMEWORKS}/libs/automation/qtp.swc", null,
                                                       projectType, null ) );
                // Source path changed
