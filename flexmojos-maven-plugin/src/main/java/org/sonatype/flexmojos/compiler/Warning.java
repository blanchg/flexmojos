...
public class Warning
{
    ...
    /**
     * Turn on reporting of data binding warnings. For example: Warning: Data binding will not be able to
     * detectAssignments to "foo".
     */
    ...
    /**
     * Function used in new expression returns a value. Result will be what the function returns, rather than a new
    ...
    /**
     * level is no longer supported. For more information, see the flash.display package.
     */
    ...
    /**
     * In ActionScript 3.0, white space is ignored and '' returns 0. Number() returns NaN in ActionScript 2.0 when the
     * parameter is '' or contains white space.
     */
    private boolean numberFromStringChanges = false;

    /**
     * Change in scoping for the this keyword. Class methods extracted from an instance of a class will always resolve
     * this back to that instance. In ActionScript 2.0 this is looked up dynamically based on where the method is
     * invoked from.
     */
    ...
    /**
     * Toggles whether the use of deprecated APIs generates a warning. This is equivalent to using the
     * <code>compiler.show-deprecation-warnings</code> option of the mxmlc or compc compilers.
     */
    private boolean deprecation = true;

    /**
     * Toggles whether warnings are displayed when an embedded font name shadows a device font name. This is equivalent
    ...
    public void setAssignmentWithinConditional( boolean assignmentWithinConditional )
    {
    ...
    public void setBooleanConstructorWithNoArgs( boolean booleanConstructorWithNoArgs )
    {
    ...
    public void setDeprecatedEventHandlerError( boolean deprecatedEventHandlerError )
    {
    ...
    public void setNoExplicitSuperCallInConstructor( boolean noExplicitSuperCallInConstructor )
    {
